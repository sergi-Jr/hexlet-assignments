...
public class ProductsController {
    ...
    public Product create(@RequestBody Product data) {
        ExampleMatcher matcher = ExampleMatcher.matching()
                .withIgnorePaths("id")
                .withMatcher("price", ExampleMatcher.GenericPropertyMatchers.ignoreCase())
                .withMatcher("title", ExampleMatcher.GenericPropertyMatchers.ignoreCase());
        if (productRepository.exists(Example.of(data, matcher))) {
            throw new ResourceAlreadyExistsException("Product with title: " + data.getTitle() + " and price: " + data.getPrice() + " already exists");
        }
